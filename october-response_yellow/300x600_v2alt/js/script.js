...
var l1 = "-76" // position ("-48") minus half the size transform difference (57)
,		t1 = 215 // position (233) minus half the size transform difference (57)
,		l2 = 68
,		t2 = 150 //position (150) adjustment to center middle icon
,		l3 = 211 // position (240) minus half the size transform difference (57)
,		t3 = 215 // position (229) minus half the size transform difference (57)
,		l4 = 320
,		t4 = 320
,		l0 = "-180"
,		t0 = 320
...
.from( f2_t1, 1, {top: "-=20", ease:"easeInOutBack"},"-=0.5")
...
.to( f3_t1, 0.5, {top: "-=20",autoAlpha:0, ease:"easeInOutBack"},"-=1.5")
...
.to( f5_i1, 0.5, {scale:1,left:13,top:112, ease:"easeInOut"},"-=0.5")

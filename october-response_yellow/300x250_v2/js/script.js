...
.to( f1_i1, 0.5, {scale:0.6, left:l1, top:t1, ease:Back.easeOut.config(0.8)},"-=0.5")
...
.to( f4_i1, 1, {scale:0.4,opacity:o2,left:l1,top:t1, ease:Back.easeOut.config(0.8)},"-=1")
...
.to( f3_i1, 1, {scale:0.6,opacity:o1,left:l3,top:t3,autoAlpha:0, ease:Back.easeOut.config(0.8)},"-=1")
.to( f2_i1, 1, {scale:0.4,opacity:o2,left:l4,top:t4,autoAlpha:0, ease:Back.easeOut.config(0.8)},"-=1")

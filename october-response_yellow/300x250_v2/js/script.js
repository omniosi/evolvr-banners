...
.to( f4_i1, 1, {scale:0.5,left:120,top:-58, ease:"easeInOutBack"},"four")
...
.from( f4_t2, 1, {top: "-=20", ease:"easeInOutBack"},"-=0.5")
.to( f4_t2, 1, {opacity:1, ease:"easeInOutBack"},"-=1")
.to( f4_i1, 1, {scale:1,left:185,top:33, ease:"easeInOutBack"},"-=2")
.to( f3_i1, 1, {scale:0.5,left:300,top:88,autoAlpha:0, ease:"easeInOutBack"},"-=2")
.to( f2_i1, 1, {left:300,top:100,autoAlpha:0, ease:"easeInOutBack"},"-=2")

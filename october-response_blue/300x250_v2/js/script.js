...
.from(s2t1, 0.5, {top:100, ease:"easeInOutBack"}, "+=0.5")
.to(s2t2, 0.5, {css: {opacity:1}, ease:"easeInOutBack"}, "-=0.5")
.from(clock1,0.25,{scale:0,ease:"easeInOutBack"})
.from(clock4,0.25,{scale:0,ease:"easeInOutBack"})
.from(clock6,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock3,0.25,{scale:0,ease:"easeInOutBack"})
.from(clock2,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock5,0.25,{scale:0,ease:"easeInOutBack"})
...
.from(s4box, 1, {css: {right:-300}, ease:"easeOutExpo"}, "-=0.25")
.to(scroller, 1, {autoAlpha:1, ease:"easeInOutBack"},"-=0.5")
.to(footer, 1, {autoAlpha:1, ease:"easeInOutBack"}, "-=1")
.to(s4box, 1, {opacity:0, ease:"easeOut"}, "+=1")
...
.to(s5logo, 1, {top:10, ease:"easeInOutExpo"},"-=0.5")

...
.from(s4box, 1, {css: {right:-300}, ease:"easeInOutBack"}, "-=0.25")
.to(scroller, 1, {autoAlpha:1, ease:"easeInOutBack"})
.to(footer, 1, {autoAlpha:1, ease:"easeInOutBack"}, "-=1")
.to(s4box, 1, {opacity:0, ease:"easeInOutBack"}, "+=1")
.to(s5, 1, {autoAlpha:1, ease:"easeInOutBack"}, "-=1")
.to(s4t1, 0.5, {css: {opacity:0}, ease:"easeInOutBack"}, "fourout")
.to(s4t2, 0.5, {css: {opacity:0}, ease:"easeInOutBack"}, "fourout")
.to(s5logo, 1, {top:10, ease:"easeInOutBack"},"-=0.5")
.from(s5t1, 1, {top:"-=20", opacity:0, ease:"easeInOutBack"},"-=0.8")
.from(cta, 1, {right:-200, ease:"easeInOutBack"}, "cta-=0.25")
.to(cta, 1, {opacity:1, ease:"easeInOutBack"}, "cta-=0.25")

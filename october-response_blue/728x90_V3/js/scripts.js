...
.from(s2t1, 0.5, {top:32, ease:"easeInOutBack"}, "+=0.5")
...
.from(clock7,0.25,{scale:0,ease:"easeInOutBack"})
.to(s2, 1, {autoAlpha:0, ease:"easeInOutBack"},"cross")
.to(s3, 1, {autoAlpha:1, ease:"easeInOutBack"},"cross")
.from(s3t2, 0.5, {opacity:0, top:108, ease:"easeInOutBack"})
...
.to(s4box, 1, {scale:0.7, right:274, top:-5, ease:Expo.easeInOut},"+=0.5")
...
.to(s4box, 1, {top:"+=100", ease:Expo.easeInOut}, "-=0.5")
.from(s5logo, 1, {top:"-=100", ease:Expo.easeInOut},"-=1")

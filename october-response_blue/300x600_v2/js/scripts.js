...
.from(s2t2, 1, {top:"-=20", ease:"easeInOutBack"})
.to(s2t2, 1, {css: {opacity:1}, ease:"easeInOutBack"}, "-=1")
.from(clock1,0.25,{scale:0,ease:"easeInOutBack"})
.from(clock4,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock6,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.25")
.from(clock3,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock2,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.25")
.from(clock5,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
// .from(clock7,0.5,{scale:0,ease:"easeInOutBack"}, "-=0.25")
.from(clock8,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock9,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.25")
.from(clock10,0.25,{scale:0,ease:"easeInOutBack"}, "-=0.5")
.from(clock11,0.25,{scale:0,ease:"easeInOutBack"})
// .from(clock12,0.5,{scale:0,ease:"easeInOutBack"})
.to(s2, 1, {autoAlpha:0, ease:"easeInOutBack"},"cross+=1")
.to(s3, 1, {autoAlpha:1, ease:"easeInOutBack"},"cross+=1")
.to(s2t2, 1, {top:"-=20", ease:"easeInOutBack"},"cross+=1")
.from(s3t2, 0.5, {opacity:0, top:"-=20", ease:"easeInOutBack"},"-=0.5")
.from(pin1,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"})
.from(pin2,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"}, "-=0.5")
.from(pin3,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"})
.from(pin4,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"}, "-=0.5")
.from(pin5,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"})
// .from(pin6,0.5,{top:"-=30",opacity:0,ease:"easeInOutBack"})
.from(pin7,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"}, "-=0.5")
.from(pin8,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"})
// .from(pin9,0.5,{top:"-=30",opacity:0,ease:"easeInOutBack"})
.from(pin10,0.25,{top:"-=30",opacity:0,ease:"easeInOutBack"}, "-=0.5")
...
.from(s4box, 1, {css: {right:"-=350"}, ease:"easeOutExpo"}, "-=0.5")
